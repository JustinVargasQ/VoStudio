...
const CATEGORY_DEFS = [
  { id: 'precio',    color: '#E03877', icon: 'M12 1v22M17 5H9.5a3.5 3.5 0 1 0 0 7h5a3.5 3.5 0 1 1 0 7H6' },           // wallet/$
  { id: 'hosting',   color: '#FF6A63', icon: 'M2 12h20M2 12a10 10 0 0 1 20 0M2 12a10 10 0 0 0 20 0M12 2a15 15 0 0 1 0 20M12 2a15 15 0 0 0 0 20' }, // globe
  { id: 'contenido', color: '#FF5C9A', icon: 'M12 20h9M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4z' },               // pencil
  ...
  { id: 'remoto',    color: '#B79CFF', icon: 'M2 3h20v14H2zM8 21h8M12 17v4' },                                          // monitor
  { id: 'industria', color: '#14B8A6', icon: 'M3 21h18M5 21V8l7-5 7 5v13M9 9h2M13 9h2M9 13h2M13 13h2M9 17h2M13 17h2' }, // building
  { id: 'propiedad', color: '#FF6A63', icon: 'M21 12V7H5a2 2 0 1 1 0-4h14v4M3 5v14a2 2 0 0 0 2 2h16v-5M18 12a2 2 0 0 0 0 4h4v-4z' }, // wallet
];
